clear; close all;
%% settings
folder = 'Test'; % folder contains testing images
savepath = '../test.h5'; %hdf5 file contains testing samples
size_input = 11; % specify the same value as generate_train
size_label = 19; % specify the same value as generate_train
scale = 3; % specify the same value as generate_train
stride = size_input;
